...
/////////////////////////////////////////// div longest wall centerTri end
...
/*! 
 */
int DivisionVolumeViaLongestWall3DCenterTriangulation::
flag(Tissue *T,size_t i,
     DataMatrix &cellData,
     DataMatrix &wallData,
     DataMatrix &vertexData,
...
//! Updates the dividing cell by adding a prependicular wall from the longest in 3DCenterTriangulation
/*! 
 */
void DivisionVolumeViaLongestWall3DCenterTriangulation::
update(Tissue *T,size_t i,
       DataMatrix &cellData,
       DataMatrix &wallData,
       DataMatrix &vertexData,
...
DivisionShortestPath::getCandidates(Tissue* T, size_t i,
                                    DataMatrix &cellData,
                                    DataMatrix &wallData,
                                    DataMatrix &vertexData,
                                    DataMatrix &cellDerivs,
