...
//BEGIN some trial workaround mac compiler errors
template <typename ScalarType>
typename ply_parser::scalar_property_definition_callback_type<ScalarType>::type& at ( ply_parser::scalar_property_definition_callbacks_type& scalar_property_definition_callbacks )
{
    return scalar_property_definition_callbacks.get<ScalarType>();
}
template <typename ScalarType>
...
template <typename SizeType, typename ScalarType>
const typename ply_parser::list_property_definition_callback_type<SizeType, ScalarType>::type& at ( const ply_parser::list_property_definition_callbacks_type& list_property_definition_callbacks )
{
    return list_property_definition_callbacks.get<SizeType, ScalarType>();
}
//END some trial workaround mac compiler errors
} // namespace ply
